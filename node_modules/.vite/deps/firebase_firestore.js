...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  Li(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.Di(e2.leaseTimestampMs, 5e3) && !this.Fi(e2.ownerId) && !this.wi(e2) && !(this._i || this.allowTabSynchronization && e2.allowTabSynchronization)) throw new FirestoreError(C2.FAILED_PRECONDITION, Ae);
    });
  }
  /**
  ...
  vo(e, t, n) {
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        } else __PRIVATE_logDebug(me, `RPC '${e}' stream ${r2} received:`, i2), P2.Vo(i2);
      }
...
var __PRIVATE_DatastoreImpl = class extends class Datastore {
  ...
  A_() {
    if (this.d_) throw new FirestoreError(C2.FAILED_PRECONDITION, "The client has already been terminated.");
  }
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new FirestoreError(C2.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
